...
\newcommand{\ZSummand}{D_{Rs} - \E_R D_{Rs}}
...
\newcommand{\vSummand}{\ensuremath{(D_{Rt} - \E_R D_{Rt})(D_{Rs} - \E_R D_{Rs}) \vWeight}}
...
\newcommand{\varianceTermIDefn}{\ensuremath{P^{-1}\oosSum{s,t}{1}
    \vSummand}}
\newcommand{\varianceTermI}{\ensuremath{\sigma_{R,0\delta}^2}}
\newcommand{\varianceTermII}{\ensuremath{\sigma_{R,1\delta}^2}}
...
\newcommand{\varianceTermIIb}{\ensuremath{(P\gamma)^{-1/2}
    ...
    \kernelB{j/\gamma}}}
\newcommand{\varianceTermIII}{\ensuremath{\sigma_{R,2\delta}^{2}}}
\newcommand{\varianceTermIIIa}{\ensuremath{(P\gamma)^{-1/2}
    \sum_{l=\vttLower}^{\vttUpper} (D_{t+l+R,R} - \E_R D_{t+l+R,R})
    W(l/\gamma)}}
\newcommand{\varianceTermIV}{\ensuremath{\sigma_{R,3\delta}^{2}}}
...
\newcommand{\varianceDiffA}{\ensuremath{P^{-1} \oosSum{s,t}{1}
    \lvert (D_{Rs} - \E_R D_{Rs})(\E_R D_{Rt} - \oosA) \rvert
    \vWeight}}
